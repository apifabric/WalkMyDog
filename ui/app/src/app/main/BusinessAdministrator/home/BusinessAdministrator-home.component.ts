...
@Component({
  selector: 'BusinessAdministrator-home',
  templateUrl: './BusinessAdministrator-home.component.html',
  styleUrls: ['./BusinessAdministrator-home.component.scss']
})
export class BusinessAdministratorHomeComponent implements AfterViewInit {
